                        ...
                        <div className="space-y-4">
                            <div className="p-4 rounded-xl bg-white/5">
                                <div className="flex items-center justify-between">
                                    ...
                                    <a href="https://wooting.io/wooting-60he?ref=nds" target="_blank" rel="nofollow sponsored" className="px-4 py-2 rounded-full bg-pink-500 text-white text-sm font-semibold">$175</a>
                                </div>
                            </div>
                            <div className="p-4 rounded-xl bg-white/5">
                                <div className="flex items-center justify-between">
