                    ...
                    <section className="mb-12 p-6 rounded-2xl bg-gradient-to-br from-pink-500/10 to-red-500/10 border border-pink-500/30">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="p-4 rounded-xl bg-white/5 flex items-center justify-between flex-wrap gap-4">
                                ...
                                <a href="https://www.amazon.com/dp/B08G7RG9ML?tag=nestdigital-20" target="_blank" rel="nofollow sponsored" className="px-4 py-2 rounded-full bg-red-500 text-white text-sm font-semibold">$249</a>
                            </div>
                            <div className="p-4 rounded-xl bg-white/5 flex items-center justify-between flex-wrap gap-4">
                                <div>
                                ...
                                <a href="https://www.amazon.com/dp/B0BZ75NQT6?tag=nestdigital-20" target="_blank" rel="nofollow sponsored" className="px-4 py-2 rounded-full bg-green-500 text-white text-sm font-semibold">$99</a>
                            </div>
                        </div>
                    </section>
