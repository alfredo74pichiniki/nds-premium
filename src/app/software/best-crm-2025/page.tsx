                        ...
                        <section className="mb-12">
                            ...
                            <div className="space-y-4">
                                <div className="p-4 rounded-xl bg-orange-500/10 border border-orange-500/30">
                                    ...
                                    <a href="https://www.hubspot.com/pricing/crm" target="_blank" rel="noopener" className="inline-flex items-center gap-2 mt-4 px-5 py-2 rounded-full bg-orange-500 text-white text-sm font-semibold hover:bg-orange-600 transition-colors">
                                ...
                                <div className="p-4 rounded-xl bg-blue-500/10 border border-blue-500/30">
                                    ...
                                    <a href="https://www.salesforce.com/editions-pricing/sales-cloud" target="_blank" rel="noopener" className="inline-flex items-center gap-2 mt-4 px-5 py-2 rounded-full bg-blue-500 text-white text-sm font-semibold hover:bg-blue-600 transition-colors">
                                ...
                                <div className="p-4 rounded-xl bg-green-500/10 border border-green-500/30">
                                    ...
                                    <a href="https://www.pipedrive.com/pricing" target="_blank" rel="noopener" className="inline-flex items-center gap-2 mt-4 px-5 py-2 rounded-full bg-green-500 text-white text-sm font-semibold hover:bg-green-600 transition-colors">
